...
// const topImage = require('../../../assets/images/NOMBRE_DE_TU_IMAGEN.png');
      ...
      >
        ...
        */}
        <View style={styles.topImagePlaceholder}>
          <Ionicons name="image-outline" size={44} color="rgba(255,255,255,0.25)" />
          <Text style={styles.placeholderText}>Imagen aquí</Text>
        </View>
        ...
        <View style={styles.textBlock}>
          ...
          <Text style={styles.titleAccent}>¿eres?</Text>
        </View>
        ...
        <View style={styles.cardsRow}>
          ...
          <Animated.View style={{ flex: 1, transform: [{ scale: pulse }] }}>
            ...
            >
              <View style={[styles.cardIconCircle, { backgroundColor: 'rgba(255,107,53,0.15)' }]}>
                <Ionicons name="bicycle" size={34} color="#FF6B35" />
              </View>
              <Text style={styles.cardTitle}>Asociado</Text>
              <Text style={styles.cardDesc}>Repartidor</Text>
            </Pressable>
          </Animated.View>
          ...
          >
            ...
            <Text style={styles.cardDesc}>Gestión</Text>
          </Pressable>
        </View>
